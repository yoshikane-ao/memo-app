...
import { useViewControl } from '../memoViewControl/useViewControl.ts'; // 表示制御共通ロジック
...
const props = defineProps({
  viewConfig: {
    type: Object,
    default: () => ({ keyword: '', sortOrder: 'custom', selectedTags: [] })
  }
});
...
const { keyword, sortOrder, selectedTags, displayedMemos } = useViewControl(memos);
